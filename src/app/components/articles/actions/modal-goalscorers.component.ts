...
@Component({
  selector: 'modal-goalscorers-component',
  template: `
    <button type="button" class="btn btn-primary d-inline-block mr-3" (click)="showModal()">ბომბარდირების ცხრილის ჩასმა</button>
    <div class="modal fade" bsModal #modal="bs-modal"
         tabindex="-1" role="dialog" aria-labelledby="dialog-events-name">
      <div class="modal-dialog modal-md">
        <div class="modal-header">
          <h4 class="modal-title pull-left">დაამატეთ ბომბარდირების ცხრილი</h4>
...
export class ModalGoalscorersComponent implements OnInit {
